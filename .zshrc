...
alias pconfig='nano ~/.config/polybar/config'
alias sconfig='nano ~/.config/sxhkd/sxhkdrc'
alias bconfig='nano ~/.config/bspwm/bspwmrc'
alias zconfig='nano ~/.zshrc'
alias comandos='nano ~/Documentos/comandos'
alias rpolybar='/home/miguel/.config/polybar/launch.sh'
